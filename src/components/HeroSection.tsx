  ...
  return (
    <section className="relative  w-full  overflow-x-hidden  ">
      ...
      <video
        ...
        muted
        loop
        className="absolute  backdrop-blur-lg w-full max-w-[1440px] bg-[#fcfcfc]/20   object-cover z-0 xl:-top-[4%]  top-4 lg:-top-32 -right-[200px] lg:-right-[300px] xl:-right-[470px] "
