...
function Navbar() {
  return (
    <div className="max-lg:px-0 px-6">
      <header className="bg-[#FCFCFC] rounded-[18px] shadow-[0_4px_100px_0_rgba(2,2,18,0.10)] h-[105px] flex items-center relative z-[1000]  w-full  justify-between pl-10 pr-6 flex-row">
        {/* header */}
        <Link href="/">
